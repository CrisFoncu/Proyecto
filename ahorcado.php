...
<body>
    ...
    <div class="container">
        <div class="card">
            <div class="header">
                <h3>Juego de Adivina la Palabra</h3>
            </div>
            <div class="card-body">
                <div class="game-area">
                    <p>Palabra: <?php echo implode(' ', $letras_adivinadas); ?></p>
                    ...
                    <?php if ($intentos > 0 && $mensaje == ''): ?>
                        <form method="POST">
                            <div class="mb-3">
                                <label for="letra" class="form-label">Adivina una letra:</label>
