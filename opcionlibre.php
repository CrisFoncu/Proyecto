...
<body>
    ...
    <div class="container mt-4">
        <div class="header">
            <h2>Bienvenido a la Opción Libre</h2>
            <p>Aquí podrás participar en diferentes juegos para ganar puntos y aumentar tu nivel de tarjeta. Cuanto más
                puntos consigas, más beneficios obtendrás. ¡Diviértete y mejora tu experiencia con nosotros!</p>
        </div>
        ...
        <div class="menu">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">Pon a prueba tu conocimiento y adivina las palabras. ¡Cada acierto te da
                        puntos!</p>
                    <a href="carga2.php" class="btn btn-light">Jugar al Ahorcado</a>
                    <h5 class="card-title">Simon Dice</h5>
                    <p class="card-text">Diviértete jugando al Simon Dice y gana puntos con cada victoria.</p>
                    <a href="carga3.php" class="btn btn-light">Jugar a Simon Dice</a>
                    <h5 class="card-title">Opción por Definir</h5>
                    <p class="card-text">Una nueva opción llegará pronto, ¡mantente atento para más sorpresas!</p>
                    <a href="#" class="btn btn-light disabled">Próximamente</a>
                </div>
            </div>
        </div>
    </div>
